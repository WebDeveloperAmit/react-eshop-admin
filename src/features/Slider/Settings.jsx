            ...
            <div className="my-account__edit-form">
                <form className="form-new-product form-style-1">
                    ...
                    <fieldset className="name">
                        ...
                        <input className="flex-grow" type="text" placeholder="Email Address" name="email" />
                    </fieldset>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <fieldset className="name">
                                ...
                                <input className="flex-grow" type="password" placeholder="Old password" id="old_password" name="old_password" />
                            </fieldset>
                        </div>
                        ...
                        <div className="col-md-12">
                            <fieldset className="name">
                                ...
                                <input className="flex-grow" type="password" placeholder="New password" id="new_password" name="new_password" />
                            </fieldset>
                        </div>
                        ...
                        <div className="col-md-12">
                            <fieldset className="name">
                                ...
                                <input className="flex-grow" type="password" placeholder="Confirm new password" cfpwd data-cf-pwd="#new_password" id="new_password_confirmation" name="new_password_confirmation" />
