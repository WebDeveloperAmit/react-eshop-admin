...
export const editSliderService = async (sliderId) => {
    try {
        const response = await axiosInstance.get(`/admin/slider/${sliderId}`);
        return response.data;
    } catch (error) {
...
export const deleteSliderService = async (sliderId) => {
    try {
        const response = await axiosInstance.delete(`/admin/slider/delete/${sliderId}`);
        return response.data;
    } catch (error) {
...
export const searchSliderService = async (searchSlider) => {
    try {
        const response = await axiosInstance.get(
            `/admin/sliders?search=${searchSlider}`
        );
        return response.data;
    } catch (error) {
